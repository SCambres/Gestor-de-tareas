...
<div class="container-fluid" id="login-container-img">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="card m-5">
                <span class="text-centrado text-dark mt-3"><h3><strong>Crear una tarea nueva</strong></h3></span>
                ...
                <form id="formularioTarea" class="card-body cardbody-color p-lg-5" method="post">
                    ...
                    <div class="text-centrado">
                        <button type="button" id="crearTarea" class="btn px-5 mb-2 w-100 botonesLogin">Crear</button>
                    </div><hr>
