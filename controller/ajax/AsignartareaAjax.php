...
if (isset($_POST['NameTarea'], $_POST['Descripcion'], $_POST['FechaInicio'], $_POST['FechaFinal'], $_POST['NumeroProyecto'], $_POST['NumeroUsuario'])
    && !empty($_POST['NameTarea']) && !empty($_POST['Descripcion']) && !empty($_POST['FechaInicio']) && !empty($_POST['FechaFinal']) && !empty($_POST['NumeroProyecto']) && !empty($_POST['NumeroUsuario'])) {
    ...
    $UsuarioSeleccionado = $_POST['NumeroUsuario'];
    ...
    $tarea->setUserId($UsuarioSeleccionado);
